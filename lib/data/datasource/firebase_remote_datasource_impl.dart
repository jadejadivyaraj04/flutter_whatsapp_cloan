...
import 'package:flutter_whatsapp_cloan/data/model/my_chat_model.dart';
import 'package:flutter_whatsapp_cloan/data/model/text_message_model.dart';
import 'package:flutter_whatsapp_cloan/data/model/user_model.dart';
...
class FirebaseRemoteDataSourceImpl implements FirebaseRemoteDataSource {
  ...
  Stream<List<TextMessageEntity>> getMessages(String channelId) {
    ...
    return messagesRef.orderBy('time',descending: true).snapshots().map(
