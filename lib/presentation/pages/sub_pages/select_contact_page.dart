...
import 'package:flutter_whatsapp_cloan/presentation/pages/sub_pages/single_communication_page.dart';
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => SingleCommunicationPage(
                  recipientName: contacts[index].label ?? "recipientName",
                  recipientPhoneNumber: contacts[index].phoneNumber ?? "recipientPhoneNumber",
                  recipientUID: contacts[index].uid ?? "recipientUID",
                  senderName: widget.userInfo.name ?? "senderName",
                  senderUID: widget.userInfo.uid ?? "senderUID",
                  senderPhoneNumber: widget.userInfo.phoneNumber ?? "senderPhoneNumber",
                )
              ));
